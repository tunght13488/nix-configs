...
Make the herdr agent skill (SKILL.md from the herdr flake input) available globally for both Pi and OpenCode agents via a Nix derivation and home-manager-managed symlinks.
