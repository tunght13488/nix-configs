...
Make all OpenSpec experimental workflow skills, prompt templates, and slash commands available to Pi and OpenCode agents globally (in any project directory) via home-manager-managed files.
