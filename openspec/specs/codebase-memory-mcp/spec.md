...
Provide a declarative Nix package and home-manager module for codebase-memory-mcp, a high-performance code intelligence engine that indexes codebases into a persistent knowledge graph. The module installs the binary and symlinks a pi skill teaching the agent to use CLI-based graph queries for code discovery instead of grep/file-read loops.
